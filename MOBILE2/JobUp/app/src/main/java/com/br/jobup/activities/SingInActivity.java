...
/*
 * Created by Luiz Carlos Ramos on 6/7/17 12:03 AM
 *
 * Copyright (c) 2017. All rights reserved.
 * Last modified 6/1/17 7:14 PM
 */
...
//                                gsonSharedPrefs.saveObject(usuarioCorrente);
                                final PreferencePersistence<Usuario> persistence = new PreferencePersistence<>(SingInActivity.this);
                                persistence.saveObjectInPreferences("UsuarioCorrent", usuarioCorrente);
                                progDialog.dismiss();
                                final Intent intent = new Intent(SingInActivity.this, MainActivity.class);
                                intent.putExtra("usuarioCorrent", usuarioCorrente);
                    ...
                    public void onFailure(Call<Usuario> call, Throwable t) {
                        ...
                        Toast.makeText(SingInActivity.this, "Falha na conexão.", Toast.LENGTH_SHORT).show();
