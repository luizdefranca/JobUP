...
namespace JOB.HELPERS.Validation
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentNotEmptyNotNull(string stringValue, string message)
        {
            if (String.IsNullOrEmpty(stringValue))
            {
                throw new Exception(message);
        ...
        protected void SelfAssertArgumentNotEmptyNotNull(string stringValue, string message)
        {
            AssertionConcern.AssertArgumentNotEmptyNotNull(stringValue, message);
        }
