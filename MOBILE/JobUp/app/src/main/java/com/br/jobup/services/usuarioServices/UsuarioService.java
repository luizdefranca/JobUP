...
public class UsuarioService   {
    ...
    public void getAllUsuarios(Context context) {
        ...
        usuariosCall =  new RetroFitInicializador().createUsuarioService().getAllUsuarios();
...
//    Call<List<Usuario>> usuarioService = new RetroFitInicializador().createUsuarioService().getAllUsuarios();
